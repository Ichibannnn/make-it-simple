...
const Department = () => {
  ...
  const [
    getDepartments,
    { isLoading: isDepartmentLoading, isFetching: isDepartmentFetching },
  ] = useLazyGetDepartmentsQuery();
  const [
    syncDepartments,
    {
      isLoading: isDepartmentSyncLoading,
      isFetching: isDepartmentSyncFetching,
    },
  ] = useSyncDepartmentMutation();
        ...
        >
          ...
          <LoadingButton
            ...
            loading={
              ...
              isDepartmentSyncLoading ||
              isDepartmentSyncFetching
            }
            sx={{
              ":disabled": {
