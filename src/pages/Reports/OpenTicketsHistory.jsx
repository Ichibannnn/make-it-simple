...
const OpenTicketsHistory = ({ search, searchValue, setSearchValue, unit, user, dateFrom, dateTo, pageNumber, setPageNumber, pageSize, setPageSize }) => {
    ...
    <Stack sx={{ width: "100%" }}>
      <Stack>
        <Stack direction="row" justifyContent="space-between" alignItems="center" m={2}>
          <Stack>
            <Typography variant="h5">Open Tickets Report</Typography>
          </Stack>
