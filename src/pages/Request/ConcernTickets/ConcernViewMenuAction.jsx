...
const ConcernViewMenuActions = ({ editData, fileName, onView, onViewWithoutId, onDelete, onDownload, isImageFile, viewLoading, setIsLoading, downloadLoading, setIsMenuOpen }) => {
...
export default ConcernViewMenuActions;
